...
- description 包含：
  ...
  8. 结合最新完成交易日的 candlestick 与近期走势，提出技术面支撑、阻力和趋势判断；不得把技术讯号当成基本面价值
...
- description 包含：
  ...
  7. 提供基本面入场价格带、分批建仓条件、加仓与减码触发器，并区分情境估值与确定价值
...
对于每日股票报告，team-lead 汇总时必须在行情图后先输出「每日事件简报」：标注研究时点、已确认事实、未确认传闻或资料缺口、事件对收入/利润/估值的可能传导，以及下一步可观察验证项。发布、展示或产品活动本身不得直接当作收入、利润或估值证据。
...
- 必须单独呈现「入场点分析」：最新 candlestick 与近期趋势、均线/支撑/阻力、基本面估值区间、分批建仓、持仓管理与论点失效条件
